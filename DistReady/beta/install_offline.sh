...
# Note: bind-interfaces removed for better timing compatibility
...
if [ -f "./configure.sh" ]; then
    ...
    echo -e "  ${YELLOW}⚠${NC} configure.sh not found (skipping auto-detection)"
fi
...
if [ -f "secgen.py" ]; then
    ...
    echo -e "${YELLOW}Warning: secgen.py not found in current directory${NC}"
fi
